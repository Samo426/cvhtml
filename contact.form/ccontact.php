...
// configure
$from = 'mail@mail.fr'; // TON MAIL d'envoie
$sendTo = 'samuel42600@gmail.com'; // ton mail a toi
...
$okMessage = ' <br> Le formulaire de contact a été soumis avec succès. Merci, je vous recontacterai bientôt ! <br>';
$errorMessage = ' <br> Une erreur s\'est produite lors de la soumission du formulaire. Veuillez réessayer plus tard <br>';

// let's do the sending

if(isset($_POST['g-recaptcha-response']) && !empty($_POST['g-recaptcha-response'])):
    //your site secret key
    $secret = 'ta clé secrete google pour le catptcha';
